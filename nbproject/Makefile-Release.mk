...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sesion.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sesion ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/practicaFinal.o: practicaFinal.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/practicaFinal.o practicaFinal.cpp
...
${OBJECTDIR}/sesion4.o: sesion4.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sesion4.o sesion4.cpp

${OBJECTDIR}/sesion5.o: sesion5.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sesion5.o sesion5.cpp
